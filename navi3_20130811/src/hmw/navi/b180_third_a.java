...
public class b180_third_a extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.t_180_1);
        Log.i("navi180", "b180_third_a - 19");
        
        Button BtnA1 = (Button) findViewById(R.id.b180_t1_button1);
        BtnA1.setOnClickListener(this);
        Button BtnA2 = (Button) findViewById(R.id.b180_t1_button2);
        BtnA2.setOnClickListener(this);
        Button BtnA3 = (Button) findViewById(R.id.b180_t1_button3);
	...
	public void onClick(View v) {
		...
		if(v.getId() == R.id.b180_t1_button1){
		...
		}else if(v.getId() == R.id.b180_t1_button2){
			Intent intent = new Intent(this, b24a.class);
			Bundle bundle = new Bundle() ;
			bundle.putString("category", "180") ;
			...
			intent.putExtras(bundle) ;
			startActivity(intent);
		}else if(v.getId() == R.id.b180_t1_button3){
			Intent intent = new Intent(this, b24a.class);
			Bundle bundle = new Bundle() ;
			bundle.putString("category", "180") ;
