...
public class b180_third_d extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.t_180_4);
        Log.i("navi180", "b180_third_a - 19");
        
        Button BtnA1 = (Button) findViewById(R.id.b180_t4_button1);
        BtnA1.setOnClickListener(this);
        Button BtnA2 = (Button) findViewById(R.id.b180_t4_button2);
        BtnA2.setOnClickListener(this);
        Button BtnA3 = (Button) findViewById(R.id.b180_t4_button3);
	...
	public void onClick(View v) {
		...
		if(v.getId() == R.id.b180_t4_button1){
			Intent intent = new Intent(this, b24a.class);
			Bundle bundle = new Bundle() ;
			bundle.putString("category", "180") ;
			bundle.putString("num1", "109") ;
			bundle.putString("num2", "120") ;
			intent.putExtras(bundle) ;
			startActivity(intent);
		}else if(v.getId() == R.id.b180_t4_button2){
			Intent intent = new Intent(this, b24a.class);
			Bundle bundle = new Bundle() ;
			bundle.putString("category", "180") ;
			bundle.putString("num1", "121") ;
			bundle.putString("num2", "132") ;
			intent.putExtras(bundle) ;
			startActivity(intent);
		}else if(v.getId() == R.id.b180_t4_button3){
			Intent intent = new Intent(this, b24a.class);
			Bundle bundle = new Bundle() ;
			bundle.putString("category", "180") ;
			bundle.putString("num1", "133") ;
			bundle.putString("num2", "144") ;
			intent.putExtras(bundle) ;
			startActivity(intent);
		}
